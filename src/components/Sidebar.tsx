...
const Sidebar: React.FC<SidebarProps> = ({ activePage, setActivePage }) => {
  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-white/80 backdrop-blur-md border-r border-pink-200/50 z-50">
      {/* Header */}
          ...
          <button
            ...
            className={`w-full flex items-center space-x-3 px-4 py-3 rounded-xl transition-all duration-300 text-left group ${
              activePage === item.id
                ...
                : 'text-gray-700 hover:bg-pink-50 hover:text-pink-700 hover:transform hover:scale-105'
            }`}
          >
      ...
      {/* User Profile */}
      <div className="absolute bottom-0 left-0 right-0 p-4 border-t border-pink-200/50">
